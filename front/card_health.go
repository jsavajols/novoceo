...
func (a *app) htmxHealth(c *fiber.Ctx) error {
	...
	html := fmt.Sprintf(`<div class="space-y-3">
  <p class="font-mono text-xs text-slate-500 mb-1">load average</p>
  <div class="flex gap-1.5">
    <span class="flex-1 text-center font-mono text-xs text-slate-300">%.2f</span>
    <span class="flex-1 text-center font-mono text-xs text-slate-300">%.2f</span>
    <span class="flex-1 text-center font-mono text-xs text-slate-300">%.2f</span>
  </div>
  <div class="flex items-end gap-1.5" style="height:44px">
  ...
  <div class="flex gap-1.5 mb-1">
    <span class="flex-1 text-center font-mono text-xs text-slate-600">1m</span>
    <span class="flex-1 text-center font-mono text-xs text-slate-600">5m</span>
    <span class="flex-1 text-center font-mono text-xs text-slate-600">15m</span>
  </div>
  <div class="space-y-1.5 pt-1 border-t border-slate-800">
    <div class="flex justify-between">
      <span class="font-mono text-xs text-slate-500">mémoire</span>
      <span class="font-mono text-xs text-cyan-400">%.0f%%</span>
    </div>
